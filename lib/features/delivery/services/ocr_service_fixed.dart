...
class OcrService {
  ...
  /// Enhanced method - now using only Tesseract API (ML Kit removed)
  Future<ReturnItemOcrResponse> getReturnItemsFromImageEnhanced(File imageFile,
      {bool useMLKit = false, String? orderId}) async {
    // Always use Tesseract API now (ML Kit removed)
    debugPrint('Using Tesseract API for return item detection...');
    return await getReturnItemsFromImage(imageFile);
  }
